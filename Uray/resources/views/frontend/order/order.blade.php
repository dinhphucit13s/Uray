        ...
        <div class="col-md-6 item-checkout">
            ...
            <div class="payment">
                <div class="content-type-payment">
                    <input type="radio" name="type_payment" class="showpayment" value="VNPAY">&nbsp;&nbsp;Thanh toán qua VNPAY
                ...
                <div class="content-type-payment">
                    <input type="radio" name="type_payment" class="showpayment" value="NH">Thanh toán khi nhận hàng
                    <div class="input-content">
