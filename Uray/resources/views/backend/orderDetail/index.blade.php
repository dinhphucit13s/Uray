		            ...
		            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		                <div class="breadcome-list map-mg-t-40-gl shadow-reset">
		                    <div class="row">
		                        ...
		                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
		                            <ul class="breadcome-menu">
		                                <li><a href="{{ route('order.index') }}">Quản lý đơn đặt hàng</a> <span class="bread-slash">/</span>
		                                </li>
		                                <li><span class="bread-blod">Chi tiết đơn hàng</span>
		                                </li>
		                            </ul>
		                ...
		                <div class="sparkline8-list shadow-reset">
		                    <div class="sparkline8-hd">
		                        ...
		                        <div class="main-sparkline8-hd" style="margin-top: 10px;">
		                        	...
		                        	<p class="detail-title">Tên khách hàng: {{ $order->user_name }}</p>
									<p class="detail-title">Email: {{ $order->email }}</p>
									<p class="detail-title">Địa chỉ: {{ $order->address }}</p>
									<p class="detail-title">Điện thoại: {{ $order->phone }}</p>
									<p class="detail-title">Ngày đặt hàng: {{ $order->Date }}</p>
									<p class="detail-title">Trạng thái: {{ $order->status }}</p>
		                        </div>
		                    </div>
		                        ...
		                        @if($order->status == 'Chưa xử lý')
			                        <div style="text-align: right; margin-top: 10px">
			                        	<form role="form" method="post" action="{{ route('orderBackend.update',['id'=>$order->ID])}}">
			                        		...
			                        		<button type="submit" class="btn btn-white btn-xs btn-action">Giao hàng</button>
			                        	</form>
			                        </div>
			                    @endif
		                    </div>
